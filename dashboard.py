        ...
        html.Div(className="card border-0 shadow-sm p-4 mb-4", children=[
            ...
            html.Div(className="row", children=[
                html.Div(className="col-md-4", children=[
                    ...
                    html.P('N filas × 8 columnas (Fecha + 7 ciudades)')
                ]),
                html.Div(className="col-md-4", children=[
                    html.H6('Período Temporal:', className="fw-bold"),
                    html.P('1979 - 2025 (aproximadamente 552 observaciones mensuales)')
                ]),
                html.Div(className="col-md-4", children=[
            ...
            html.Ul([
                html.Li([html.Strong('Valores faltantes: '), 'Identificación y tratamiento de NAs en las series']),
                html.Li([html.Strong('Consistencia temporal: '), 'Verificación de continuidad en las fechas mensuales']),
                html.Li([html.Strong('Outliers: '), 'Detección de valores atípicos que podrían afectar el modelo']),
...
# 3. Planteamiento del Problema
    ...
    dcc.Tab(label='4. Objetivos y Justificación', children=[
        ...
        html.Ul([html.Li('Objetivo general del proyecto:Implementar un buen modelo para obtener buenos resultados y detectar mejoras para implementar otros modelos a futuro.')]),
    ...
    dcc.Tab(label='5. Marco Teórico', children=[
        ...
        html.Div(className="card border-0 shadow-sm p-4 mb-4", children=[
            ...
            html.P('Las diferencias regionales en Colombia presentan desafíos únicos. Factores como geografía, estructura productiva local, costos de transporte y dinámicas de mercado específicas pueden generar comportamientos diferenciados en la inflación por ciudades.'),
